...
// verification.
func calcSignatureHash(script []parsedOpcode, hashType SigHashType, tx *pb.TX, idx int) []byte {
	...
	for i := range txCopy.Txin {
		if i == idx {
			...
			txCopy.Txin[idx].Script = sigScript
		} else {
			txCopy.Txin[i].Script = nil
		}
	}
