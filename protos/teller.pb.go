...
func (m *NextLotteryInfoRsp) GetStartTime() int64 {
	if m != nil {
		return m.StartTime
	}
	return 0
...
func (m *NextLotteryInfoRsp) GetEndTime() int64 {
	if m != nil {
		return m.EndTime
	}
	return 0
...
func (m *LotteryFx) GetFid() string {
	if m != nil {
		return m.Fid
	}
	return ""
...
func (m *LotteryFx) GetValue() uint64 {
	if m != nil {
		return m.Value
	}
	return 0
...
func (m *LotteryFx) GetLedgers() []string {
	if m != nil {
		return m.Ledgers
	}
	return nil
...
func (m *LotteryFx) GetDist() uint64 {
	if m != nil {
		return m.Dist
	}
	return 0
...
func (m *LotteryLx) GetLid() string {
	if m != nil {
		return m.Lid
	}
	return ""
...
func (m *LotteryLx) GetValue() uint64 {
	if m != nil {
		return m.Value
	}
	return 0
...
func (m *LotteryLx) GetDist() uint64 {
	if m != nil {
		return m.Dist
	}
	return 0
...
func (m *LotteryLx) GetFarmers() []string {
	if m != nil {
		return m.Farmers
	}
	return nil
...
func (m *LotteryFxTicket) GetFid() string {
	if m != nil {
		return m.Fid
	}
	return ""
...
func (m *LotteryFxTicket) GetFx() uint64 {
	if m != nil {
		return m.Fx
	}
	return 0
...
func (m *LotteryFxTicket) GetMr() uint64 {
	if m != nil {
		return m.Mr
	}
	return 0
...
func (m *LotteryFxTicket) GetIdx() int64 {
	if m != nil {
		return m.Idx
	}
	return 0
...
func (m *LotteryFxTicket) GetLotteryName() string {
	if m != nil {
...
func (m *SendLotteryFxReq) GetFid() string {
	if m != nil {
		return m.Fid
	}
	return ""
...
func (m *SendLotteryFxReq) GetFx() uint64 {
	if m != nil {
		return m.Fx
	}
	return 0
...
func (m *LotteryLxTicket) GetLid() string {
	if m != nil {
		return m.Lid
	}
	return ""
...
func (m *LotteryLxTicket) GetLx() uint64 {
	if m != nil {
		return m.Lx
	}
	return 0
...
func (m *LotteryLxTicket) GetLotteryName() string {
	if m != nil {
		return m.LotteryName
	}
	return ""
...
func (m *SendLotteryLxReq) GetLid() string {
	if m != nil {
		return m.Lid
	}
	return ""
...
func (m *SendLotteryLxReq) GetLx() uint64 {
	if m != nil {
		return m.Lx
	}
	return 0
...
func (m *StartLotteryReq) GetStartUTC() int64 {
	if m != nil {
		return m.StartUTC
	}
	return 0
...
func (m *StartLotteryReq) GetLastInterval() string {
	if m != nil {
...
func (m *GetLotteryResultReq) GetLotteryName() string {
	if m != nil {
		return m.LotteryName
	}
	return ""
